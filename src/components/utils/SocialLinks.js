...
const SocialLinks = () => {
    return (
        <div className="social-links">
            ...
            <a className="cv-link" alt="resume" href="https://drive.google.com/file/d/1xepoKGa9Js7pQVloLtCCBlnea6BKwdte/view" target="_blank" rel="noopener noreferrer">RESUME</a>
